...
and supported VC Data Model versions. Endpoints in most cases should be VC-API capable, can sign and/or 
verify using `did:key`, and can resolve the following contexts:
